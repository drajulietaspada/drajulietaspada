const treatmentEntries = [
  ...
  },
  {
    ...
    excerpt:
      "Es la aplicación de Xeomin® (incobotulinumtoxinA) en los músculos responsables de las arrugas dinámicas de frente, entrecejo y patas de gallo.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es el uso de Xeomin® en el músculo platisma para modular su tracción en cuello y borde mandibular.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es un tratamiento con Xeomin® dirigido a los músculos que elevan en exceso el labio superior al sonreír.",
    details: [
  ...
  },
  {
    ...
    title: "Maseteros",
    excerpt:
      "Es la aplicación de Xeomin® en el músculo masetero para modular su fuerza y su volumen.",
    details: [
  ...
  },
  {
    ...
    title: "Traptox",
    excerpt:
      "Traptox es la aplicación de Xeomin® en el músculo trapecio para modular su hiperactividad o hipertrofia.",
    details: [
  ...
  },
  {
    ...
    title: "Tarsopexia",
    excerpt:
      "Es un abordaje periocular con Xeomin® en puntos seleccionados para modular la dinámica muscular y equilibrar la mirada.",
    details: [
  ...
  },
  {
    ...
    title: "Calvestox",
    excerpt:
      "Es la aplicación de Xeomin® en pantorrillas para modular el volumen muscular en pacientes seleccionados.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "La rinomodelación es un tratamiento médico con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y el objetivo del tratamiento.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es la aplicación de ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y las necesidades de cada paciente.",
    details: [
  ...
  },
  {
    ...
    title: "Mentón",
    excerpt:
      "Es el uso de ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y el soporte requerido.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es un abordaje combinado de la región periocular con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y el diagnóstico de la zona.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es un tratamiento combinado con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y el objetivo del tratamiento.",
    details: [
  ...
  },
  {
    ...
    title: "Fosa temporal",
    excerpt:
      "Es la reposición de volumen en la región temporal con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y la necesidad de soporte.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es un tratamiento avanzado con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y las características del tejido.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es una técnica de armonización con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y la necesidad de corrección.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es la aplicación de ácido hialurónico Belotero® en la base nasal lateral, seleccionando el producto adecuado según el área anatómica y la necesidad de soporte estructural.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es el tratamiento del pliegue que va desde la base de la nariz hacia la comisura labial con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y la profundidad del surco.",
    details: [
  ...
  },
  {
    ...
    title: "Marionetas",
    excerpt:
      "Es la corrección de las líneas que descienden desde la comisura hacia el mentón mediante ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y la calidad del tejido.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es el tratamiento del pliegue entre labio inferior y mentón con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y el objetivo del tratamiento.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es una técnica de microdepósitos muy superficiales con ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y la calidad de la piel.",
    details: [
  ...
  },
  {
    ...
    excerpt:
      "Es la aplicación de ácido hialurónico Belotero®, seleccionando el producto adecuado según el área anatómica y la necesidad de soporte del tejido.",
    details: [
